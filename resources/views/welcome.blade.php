...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            <button onclick="window.open('https://www9.alfanetworks.com.br/alfacomerp/secure/login.php', '_blank')" type="button" class="btn btn-success">Site</button>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="grid grid-cols-1 md:grid-cols-2 md:grid-cols-3 md:grid-cols-4">
                    <div class="p-6">
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Brinquedos</div>
                        </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Recarga/Chip</div>
                        </div>
                ...
                <div class="text-center text-sm text-gray-500 sm:text-left">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                            Lana Novidades - Rua Capitão Joaquim Manoel Pereira, 46 - Jardim São Francisco, Limeira - SP, 13483-281
                        </div>
                    </div>
                </div>

                <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                    Cnpj:27.352.409/0001-23 IE:
                    </a>
